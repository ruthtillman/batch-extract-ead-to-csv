...
directory = "/Volumes/curatend-batch/data/EAD_Ingest_New_" + today # Hardcoded path may have issue if DCNS changes.
...
def createCSV(directory, outputFile):
    ...
    for each in files:
        ...
        line = typeString + "," + ownerString + "," + accessString + "," + each + "," + departmentString + "," + titleString + "," + scopeAndContent + "," + creator + "," + sourceString + "\n"
        f.write(line)
